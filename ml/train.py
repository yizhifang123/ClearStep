...
def _figures(honest, leak, y_subj, oof):
    ...
    fig.tight_layout()
    fig.savefig(FIG / "leakage_demo.png", dpi=130)
    plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(FIG / "confusion_matrix.png", dpi=130)
    plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(FIG / "roc_curve.png", dpi=130)
    plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(FIG / "calibration_curve.png", dpi=130)
    plt.close(fig)
